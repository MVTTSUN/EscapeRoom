        ...
        <div className="socials">
          <ul className="socials__list">
            <li className="socials__item">
              <a className="socials__link" href="https://www.skype.com" aria-label="Skype" target="_blank" rel="nofollow noopener noreferrer">
            ...
            <li className="socials__item">
              <a className="socials__link" href="https://vk.com" aria-label="ВКонтакте" target="_blank" rel="nofollow noopener noreferrer">
                <svg className="socials__icon socials__icon--default" width="28" height="28" aria-hidden="true">
