...
import { DEFAULT_MARKER_ICON, LAYER_MAP, POSITION_CONTACTS_MAP } from '../../const';
      ...
      <div className="container">
        ...
        <div className="contacts">
          ...
          <div className="contacts__map">
            <div className="map">
              <MapContainer className="map__container" center={POSITION_CONTACTS_MAP} zoom={13}>
                <TileLayer url={LAYER_MAP}/>
                <Marker icon={new Icon(DEFAULT_MARKER_ICON)} position={POSITION_CONTACTS_MAP}>
                  <Popup>
                    Санкт-Петербург, <br/>
